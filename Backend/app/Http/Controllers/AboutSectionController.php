...
class AboutSectionController extends Controller
{
    ...
    public function store(Request $request, $id)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(['message' => $message, 'about_section' => $aboutSection], 200);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(['message' => 'Data updated successfully!', 'about_section' => $aboutSection], 200);
        }
    ...
    public function destroy($id)
    {
        ...
        if ($aboutSection) {
            ...
            if (request()->wantsJson()) {
                return response()->json(['message' => 'Institute information deleted successfully.']);
            }
        ...
        if (request()->wantsJson()) {
            return response()->json(['message' => 'No information found to delete for this institute.'], 404);
        }
