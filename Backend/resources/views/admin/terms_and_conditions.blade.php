...
<body>
        ...
        <div class="main-wrapper">
            ...
            <div class="user-table">
                <div class="user-table-header">
                    <h2 class="title">Terms & Conditions Management</h2>
    ...
    <div id="addModal" class="modal" style="display:none;">
        <div class="modal-content">
            ...
            <h2>Add New Terms & Conditions</h2>
            <form id="addForm" method="POST" action="{{ route('terms.store') }}">
                @csrf
                <label>Title</label>
