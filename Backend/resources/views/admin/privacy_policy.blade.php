...
<body>
        ...
        <div class="main-wrapper">
            ...
            <div class="user-table">
                <div class="user-table-header">
                    <h2 class="title">Privacy Policy Management</h2>
                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($privacyPolicySections as $section)
                            <tr>
                                <td>{{ $section->id }}</td>
                                <td>{{ $section->title }}</td>
                                <td>
    ...
    <div id="addModal" class="modal" style="display:none;">
        <div class="modal-content">
            ...
            <h2>Add New Privacy Policy Section</h2>
            <form id="addForm" method="POST" action="{{ route('privacy_policy.store') }}">
                @csrf
                <label>Title</label>
    ...
    <div id="editModal" class="modal" style="display:none;">
        <div class="modal-content">
            ...
            <form id="editForm" method="POST">
                ...
                <label>Order</label>
                <input type="number" name="order_index" id="editOrder">
...
<script>
    function openEditModal(button) {
        ...
        form.action = '/admin/privacy-policy/' + id;
