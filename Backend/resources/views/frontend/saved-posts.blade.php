...
<head>
    <meta charset="UTF-8">
    <title>Saved Posts | UniAds</title>
                    ...
                    <div class="programme-action">
                        ...
                        @if (auth()->check() && auth()->user()->role === 'User')
                            <label class="ui-bookmark">
                                <input type="checkbox" class="save-toggle" data-post-id="{{ $post->id }}" checked>
                                <div class="bookmark">
                ...
                fetch(`/posts/${postId}/save`, {
                    ...
                    .then(data => {
                        if (data.status === 'saved') {
                            ...
                            // Optional: remove card from page after unsaving
                            location.reload();
                        }
                    })
